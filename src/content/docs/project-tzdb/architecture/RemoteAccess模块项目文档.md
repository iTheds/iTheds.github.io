---
title: "RemoteAccess模块项目文档"
description: "远程访问模块项目文档整理"
---

整理时间补注:`2021-07-09`、`2021-08-18`、`2021-10-15`、`2022-01-10`
...
该文档的主体需求、概要设计、详细设计、接口说明仍保留在本页。原先按日期推进的开发流程记录、问题清单、平台适配、开发策略、接口映射与代码体系已经拆分到以下文档：

- [RemoteAccess模块问题清单与平台适配](../engineering/RemoteAccess模块问题清单与平台适配.md)
- [RemoteAccess模块开发策略](../engineering/RemoteAccess模块开发策略.md)
- [RemoteAccess模块接口与代码体系](RemoteAccess模块接口与代码体系.md)

下面仅保留原稿中的 API 草案部分，作为接口实现占位。
