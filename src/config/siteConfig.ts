...
export const siteConfig: SiteConfig = {
	...
	// 站点副标题
	subtitle: "Notes and posts",

	// 站点 URL
	site_url: "https://itheds.github.io",

	// 站点描述
	description: "iTheds 的个人博客，记录技术、项目与随笔。",

	// 站点关键词
	keywords: ["iTheds", "Astro", "Firefly", "博客", "技术博客"],
